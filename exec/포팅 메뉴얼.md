...
pipeline {
    ...
    stages {
        ...
        stage('Node Build') {
            environment {
                VITE_APP_URL = 'https://phocafor.me/'
                VITE_APP_API_URL = 'https://phocafor.me/api/'
                VITE_APP_LOGIN_API_URL = 'http://phocafor.me:4885/'
             }
            steps {
                dir ('FrontEnd') {
                    sh 'npm install'
...
```jsx
	environment {
                ...
                APP_LOGIN_API_URL = 'http://phocafor.me:4885/'
             }
```
